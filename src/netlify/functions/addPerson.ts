...
export const handler: Handler = async (event) => {
     ...
     try {
          ...
          // Example Usage:
          /* console.log(getFullChineseZodiac(2024, 2, 9, 23)); // { yearZodiac: "Rabbit", monthZodiac: "Tiger", hourZodiac: "Rat" } */
...
const getFullChineseZodiac = (year: number, month: number, day: number, hour: number): { yearZodiac: string, monthZodiac: string, hourZodiac: string } => {
     const zodiacAnimals = [
...
const symbolDetails: ZodiacData = {
     "Rat": {
          "number": 1,
          "english": "Rat",
          "animal": "鼠 (shǔ)",
